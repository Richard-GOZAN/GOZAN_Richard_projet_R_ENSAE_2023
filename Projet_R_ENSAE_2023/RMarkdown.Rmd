...
ifelse(table_missing$key == 0, "Il n'y a pas de valeurs manquantes",  "Il y a des valeurs manquantes")
```
...
### Satistiques descriptives demandées
...
ggbivariate(data = data , outcome = "parle_wolof", explanatory = c("sexe", "region", "Niveau_instruction", "Propriete"))
